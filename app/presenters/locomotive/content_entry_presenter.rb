module Locomotive
  class ContentEntryPresenter < BasePresenter
    ...
    delegate :_label, :_slug, :_position, :translated_in, :seo_title, :meta_keywords, :meta_description,
             :file_custom_fields, :has_many_custom_fields, :many_to_many_custom_fields, :tag_set_custom_fields, :to => :source
